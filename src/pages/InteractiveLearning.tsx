...
import { useGetCourseByIdQuery, useSubmitQuizMutation } from "../api"
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="bg-white shadow-sm border-b p-4">
            <div className="flex items-center justify-between">
              <Link to={`/courses/${courseId}`} className="flex items-center text-blue-600 hover:text-blue-800">
                  ...
                  <div className="text-center">
                    <div
                      className={`inline-flex items-center px-6 py-3 rounded-full text-lg font-semibold mb-4 ${
                        quizResults.isPassed ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"
                      }`}
                    >
                      ...
                      {quizResults.correctAnswers.map((answer: any, index: number) => {
                        ...
                        return (
                          <div key={answer.questionId} className="bg-gray-50 p-4 rounded-lg">
                            ...
                            <p className="text-green-600">Correct answer(s): {answer.correctAnswers.join(", ")}</p>
                          </div>
                        )
                      })}
                    </div>
                    ...
                    {nextLesson && quizResults.isPassed && (
                      <Link
                        to={`/courses/${courseId}/lessons/${nextLesson.id}`}
                        className="mt-6 bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors inline-block"
                      >
                  ...
                  <div className="p-2">
                    {module.lessons.map((moduleLesson) => (
                      <Link
                        ...
                        className={`w-full text-left p-3 rounded-lg hover:bg-blue-50 transition-colors block ${
                      ...
                      >
                        <div className="flex items-center">
                          ...
                          {moduleLesson.circuitId && <Zap className="w-4 h-4 text-blue-500 ml-1" />}
