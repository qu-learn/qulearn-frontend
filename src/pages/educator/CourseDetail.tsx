                  ...
                  <Disclosure key={module.id} defaultOpen={true}>
                    {({ open }) => (
                      <div className="border border-gray-200 rounded-lg">
                        <Disclosure.Button className="w-full p-4 bg-gray-50 border-b border-gray-200 flex items-center justify-between text-left text-gray-900 font-semibold focus:outline-none">
